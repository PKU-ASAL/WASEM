...
class ConversionInstructions:
    ...
    def emulate(self, state):
        ...
        if self.instr_name == 'i32.wrap/i64':
            ...
            assert not (shadow0.pointer == True or shadow0.pointer == 1)
        ...
        if self.instr_name == 'i32.wrap/i64' or self.instr_name == 'i64.extend_s/i32' or self.instr_name == 'i64.extend_u/i32':
            if shadow0.pointer:
