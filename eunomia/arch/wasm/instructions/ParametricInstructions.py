...
class ParametricInstructions:
    ...
    def emulate(self, state):
        if self.instr_name == 'drop':
            ...
            shadow0, shadow1, shadow2 = state.shadow_stack.pop(), state.shadow_stack.pop(), state.shadow_stack.pop()
            assert not shadow0.pointer 
            ...
            if is_true(op):
                ...
                state.shadow_stack.append(shadow1)
                return [state]
            elif is_false(op):
                state.symbolic_stack.append(arg2)
                state.shadow_stack.append(shadow2)
                return [state]
                ...
                if no_need_true and no_need_false:
                    ...
                    new_state.shadow_stack.append(shadow2)
